function data= eval_data_3node_polyval(timeint,tmax,params,y0,yp1,yp2,yp3,pert1,pert2,pert3,noise)
...
% Generate perturbation data of the perturbed nodes
YP1(:,1)=pert1*Y(:,1);
YP2(:,2)=pert2*Y(:,2);
YP3(:,3)=pert3*Y(:,3);
...
data.T=t;
    ...
    function dzdt1 = odeqns(t,z,r)
        dzdt1 = [
            (r(1)+r(2)+r(3)*z(1)+r(4)*z(2)+r(5)*z(3))
            (r(6)+r(7)+r(8)*z(1)+r(9)*z(2)+r(10)*z(3))
            (r(11)+r(12)+r(13)*z(1)+r(14)*z(2)+r(15)*z(3))
        ];
    end
    function dzdt1 = odep1(t,z,r)
        Y_pert=polyval(poly_YP1,t);   
        dzdt1 = [
            (r(6)+r(7)+r(8)*Y_pert+r(9)*z(1)+r(10)*z(2))
            (r(11)+r(12)+r(13)*Y_pert+r(14)*z(1)+r(15)*z(2))
                 ];
    end
       function dzdt1 = odep2(t,z,r)
        Y_pert=polyval(poly_YP2,t);
        dzdt1 = [
            (r(1)+r(2)+r(3)*z(1)+r(4)*Y_pert+r(5)*z(2))
            (r(11)+r(12)+r(13)*z(1)+r(14)*Y_pert+r(15)*z(2))
        ];
       end
        ...
        dzdt1 = [
            (r(1)+r(2)+r(3)*z(1)+r(4)*z(2)+r(5)*Y_pert)
            (r(6)+r(7)+r(8)*z(1)+r(9)*z(2)+r(10)*Y_pert)
        ];
       end
end