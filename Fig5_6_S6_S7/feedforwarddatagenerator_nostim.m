function out = feedforwarddatagenerator_nostim(timeint,tmax,Ks,Bs,pert1,pert2,pert3,noise)
    ...
    for j = 1:2
        for k = 1:2
            for l = 1:2
                ...
                [Y,YP1,YP2,YP3,T] = feedforwardloop_nostim(timeint,tmax,[i j k l],K,B,pert1,pert2,pert3);
                op=op+1;
