function [Y,YP1,YP2,YP3,t]= feedforwardloop(timeint,tmax,y0,flags,K,B,pert1,pert2,pert3)
...
[t,YP1_data] = ode15s(@ffl_pert1,0:timeint:tmax,[y0(2);y0(3)],options,flags,K,B);
[t,YP2_data] = ode15s(@ffl_pert2,0:timeint:tmax,[y0(1);y0(3)],options,flags,K,B);
[t,YP3_data] = ode15s(@ffl_pert3,0:timeint:tmax,[y0(1);y0(2)],options,flags,K,B);
