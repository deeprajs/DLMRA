function out = feedforwarddatagenerator_MB5(timeint,tmax,y0,yp1,yp2,yp3,Ks,Bs,pert1,pert2,pert3,noise)
    ...
    for j = 1:2
        for k = 1:2
            for l = 1:2
                ...
                [Y,YP1,YP2,YP3,T] = feedforwardloop_nostim(timeint,tmax,y0(op,:),yp1(op,:),yp2(op,:),yp3(op,:),[i j k l],K,B,pert1,pert2,pert3);
                op=op+1;
