function [Y,YP1,YP2,YP3,t]= feedforwardloop_stim(timeint,tmax,y0,yp1,yp2,yp3,flags,K,B,pert1,pert2,pert3)
options = odeset('RelTol',1e-6);
[t,Y] = ode15s(@ffl_nopert,0:timeint:tmax,y0,options,flags,K,B);
...
[t,YP1_data] = ode15s(@ffl_pert1,0:timeint:tmax,[yp1(2);yp1(3)],options,flags,K,B);
[t,YP2_data] = ode15s(@ffl_pert2,0:timeint:tmax,[yp2(1);yp2(3)],options,flags,K,B);
[t,YP3_data] = ode15s(@ffl_pert3,0:timeint:tmax,[yp3(1);yp3(2)],options,flags,K,B);
